...
RSpec.describe Api::V1::UsersController, type: :controller do # changed to Api::V1:: like the path spec/controllers/api/v1/
  ...
  describe "GET #show" do
    ...
    it "has the product ids as an embeded objects" do
      user_response = json_response[:user]
  ...
  describe "POST #create" do
    ...
    context "when is succesfully created" do
      before(:each) do
        ...
        post :create, params: { user: @user_attributes }#, format: :json # issue post request
      end
  ...
  describe "PUT/PATCH #update" do
    ...
    context "when is not succesfully updated" do
      before(:each) do
        patch :update, params: { id: @user.id,
                                 user: { email: "invalidmail.com" } }#, format: :json
      end
      ...
      it "renders the errors json on why the user was not updated" do
        user_response = json_response
